...
public class MediaFileUtil {
    ...
    static {
        ...
        addFileType("MKV", FILE_TYPE_WMV, "video/x-matroska audio/x-matroska");
        addFileType("3GP", FILE_TYPE_WMV, "video/3gpp");
        addFileType("MOV", FILE_TYPE_WMV, "video/quicktime");
        addFileType("AVI", FILE_TYPE_WMV, "video/x-msvideo");
        addFileType("WMV", FILE_TYPE_WMV, "video/x-ms-wmv");
