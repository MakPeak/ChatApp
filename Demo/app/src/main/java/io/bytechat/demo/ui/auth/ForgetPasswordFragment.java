...
import io.bytechat.demo.databinding.FragmentForgetPasswordBinding;
import io.bytechat.demo.vm.ForgetPasswordViewModel;
import io.openim.android.ouicore.base.BaseFragment;


public class ForgetPasswordFragment extends BaseFragment<ForgetPasswordViewModel> implements ForgetPasswordViewModel.ViewAction {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.getVerificationCodeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
...
//                }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        bindVM(ForgetPasswordViewModel.class);
    ...
    public void onSucce(Object o) {
        ...
        authVM.usedFor.setValue(2);
        Navigation.findNavController(view).navigate(R.id.action_forgetPasswordFragment_to_OTPFragment);
    }
}
