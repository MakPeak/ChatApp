...
import io.bytechat.demo.databinding.LayoutAddFriendDialogBinding;
...
import io.bytechat.demo.oldrelease.ui.search.SendVerifyActivity;
    ...
    public void finishLoading(List<UserInfo> data){
        fullNickname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                long clickTimeRes = System.currentTimeMillis()- clickedTime ;
                clickTimeRes = clickTimeRes/1000;
                if( clickTimeRes <= 1 && clickedTime != -1){
                    return;
                }
