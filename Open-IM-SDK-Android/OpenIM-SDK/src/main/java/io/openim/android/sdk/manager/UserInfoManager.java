...
public class UserInfoManager {
     ...
     */
    public void setSelfInfo(OnBase<String> base, String nickname, String faceURL, int gender, int appMangerLevel,
                            String phoneNumber, long birth, String email, String ex) {
    ...
    public void setSelfNickname(OnBase<String> base, String nickname) {
        Map<String, Object> map = new ArrayMap<>();
        map.put("nickname", nickname);
        Open_im_sdk.setSelfInfo(BaseImpl.stringBase(base), ParamsUtil.buildOperationID(), JsonUtil.toString(map));
    }

    public void setSelfGender(OnBase<String> base, int gender) {
        Map<String, Object> map = new ArrayMap<>();
        map.put("gender", gender);
        Open_im_sdk.setSelfInfo(BaseImpl.stringBase(base), ParamsUtil.buildOperationID(), JsonUtil.toString(map));
    }

    public void setSelfBirthday(OnBase<String> base, String birth) {
        Map<String, Object> map = new ArrayMap<>();
        map.put("birth", birth);
        Open_im_sdk.setSelfInfo(BaseImpl.stringBase(base), ParamsUtil.buildOperationID(), JsonUtil.toString(map));
    }

    public void setSelfFaceURL(OnBase<String> base, String faceURL) {
        Map<String, Object> map = new ArrayMap<>();
        map.put("faceURL", faceURL);
        Open_im_sdk.setSelfInfo(BaseImpl.stringBase(base), ParamsUtil.buildOperationID(), JsonUtil.toString(map));
    }
