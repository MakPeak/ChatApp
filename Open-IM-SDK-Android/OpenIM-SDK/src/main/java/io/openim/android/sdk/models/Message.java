...
public class Message {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(clientMsgID, serverMsgID, createTime, sendTime, sessionType, sendID, recvID, msgFrom, contentType, platformID, senderNickname, senderFaceUrl, groupID, content, seq, isRead, status, offlinePush, attachedInfo, ext, ex, pictureElem, soundElem, videoElem, fileElem, atElem, locationElem, customElem, quoteElem, mergeElem, notificationElem, faceElem, attachedInfoElem);
    }
